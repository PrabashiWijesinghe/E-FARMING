                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <asp:Button ID="Button3" formnovalidate="True" class="btn btn-success" runat="server" Text="Calculate total" OnClick="Button3_Click" />
                            <div class="col-md-4">
                                <label>Total</label>
                                <div class="form-group">
                        ...
                        <br /><hr /><br />
                                ...
                                <asp:Button ID="Button1" formnovalidate="True" class="btn btn-success col-4" runat="server" Text="View Cart" OnClick="Button1_Click"  /><br /><br />
                                 <asp:Button ID="btncat" formnovalidate="True" class="btn btn-success col-4" runat="server" Text="View catagory" OnClick="btncat_Click"/><br /><br /><br /><br /><br /><br /><br /><br />
                                </center>
